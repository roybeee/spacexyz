...
export const designSchema=coreSceneSchema.pick({room:true,nodes:true,lighting:true,photoId:true,palette:true,draft:true,facade:true,measurements:true,layers:true,budget:true});
...
function validateLayout(s:Pick<SceneData,'room'|'nodes'|'facade'|'measurements'|'layers'|'budget'>){
