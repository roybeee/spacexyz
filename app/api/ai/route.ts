...
export async function POST(req: Request) { try {
    ...
    const input: {
        ...
        image_url?: string;
        detail?: string;
    }[] = [{ type: 'input_text', text: JSON.stringify({ request: b.prompt, selected: b.selection ?? null, scene }) }];
    if (b.image) {
