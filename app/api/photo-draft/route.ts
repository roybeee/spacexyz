...
export async function POST(req: Request) {
    try {
        ...
        if (!key)
            throw new HttpError(503, 'AI 연결 후 사진으로 3D 초안을 만들 수 있습니다.');
