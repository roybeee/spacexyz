...
export default function InteriorStudio() {
 ...
 {modal==='product-materials'&&productSnapshot&&<ProductMaterialDialog currentId={appearance?.finish.catalogId} target={currentName} onClose={()=>setModal(null)} onApply={applyProductMaterial}/>}
